  ...
  return (
    <div className="relative">
      <textarea
        ...
        className="overflow-y-scroll text-white w-full h-full p-2.5 bg-zinc-950 border border-solid rounded-lg border-orange-400 focus:border-orange-400 focus:ring-orange-400"
